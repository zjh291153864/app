...
public final class LogUtils {
    ...
    public static void v(Object obj) {
        if (Log.VERBOSE > DEBUG_LEVEL) {
            ...
            Log.v(AppUtils.getPackageName(), tag.concat("=").concat(msg));
        }
    }
    ...
    public static void d(Object obj) {
        if (Log.DEBUG > DEBUG_LEVEL) {
            String tag = getClassName();
            String msg = obj != null ? obj.toString() : "obj == null";
            Log.d(AppUtils.getPackageName(), tag.concat("=").concat(msg));
        }
    }
    ...
    public static void i(Object obj) {
        if (Log.INFO > DEBUG_LEVEL) {
            String tag = getClassName();
            String msg = obj != null ? obj.toString() : "obj == null";
            Log.i(AppUtils.getPackageName(), tag.concat("=").concat(msg));
        }
    }
    ...
    public static void w(Object obj) {
        if (Log.WARN > DEBUG_LEVEL) {
            String tag = getClassName();
            String msg = obj != null ? obj.toString() : "obj == null";
            Log.w(AppUtils.getPackageName(), tag.concat("=").concat(msg));
        }
    }
    ...
    public static void e(Object obj) {
        if (Log.ERROR > DEBUG_LEVEL) {
            String tag = getClassName();
            String msg = obj != null ? obj.toString() : "obj == null";
            String s = AppUtils.getPackageName();
            Log.e(AppUtils.getPackageName(), tag.concat("=").concat(msg));
        }
    }
    ...
    public static void wtf(Object obj) {
        if (Log.ASSERT > DEBUG_LEVEL) {
            String tag = getClassName();
            String msg = obj != null ? obj.toString() : "obj == null";
            Log.wtf(AppUtils.getPackageName(), tag.concat("=").concat(msg));
        }
    }
