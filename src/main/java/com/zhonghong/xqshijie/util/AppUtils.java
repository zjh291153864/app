...
public final class AppUtils {
     ...
     * @param btnCancelText
     */
    public static void showCallDialog(final Context mContext, final String mobile, String msg, String btnOkText, String btnCancelText) {
        if(StringUtils.isMobile(mobile)||!StringUtils.isNull(mobile)) {//不一定是手机号
            ...
            normalDialog.isTitleShow(false)
                    ...
                    .content(msg)
                    .btnText(btnCancelText,btnOkText)
    ...
    public static int gc(Context context) {
        ...
        if (DEBUG) {
            LogUtils.d("清理了" + (getDeviceUsableMemory(context) - i) + "M内存");
        }
        return count;
    }
     ...
     * 跳转到系统网络设置界面
     */
    public static void startToSystemNetSettingActivity(Context context){
        // 跳转到系统的网络设置界面
        Intent intent = null;
        // 先判断当前系统版本
