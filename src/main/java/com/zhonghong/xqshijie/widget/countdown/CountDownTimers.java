package com.zhonghong.xqshijie.widget.countdown;
...
public class CountDownTimers {
    ...
    private long mUntilInterval=0;
    private long mDoOnTickInterval=0;
...
//        long currentMillis = SystemClock.elapsedRealtime();
        mUntilInterval+=1000;
        long currentMillis = mUntilInterval;
    ...
    private void doOnTick(long maxMillisUntilFinished) {
        if (mCountDownInfoSparseArray != null) {
            ...
            //long currentMillis = SystemClock.elapsedRealtime();
            mDoOnTickInterval += 1000;
            long currentMillis = mDoOnTickInterval;
