...
public class CirclePageIndicator extends View implements OnPageChangeListener {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultOrientation = 0;//设置排列方向
        ...
        final float defaultInterval = res.getDimension(R.dimen.default_circle_dot_interval);
        ...
        mCentered = a
                .getBoolean(R.styleable.CirclePageIndicator_indicatorcentered, true);
        ...
        mRadius = a.getDimension(R.styleable.CirclePageIndicator_indicaterradius,
                defaultRadius);
        mSnap = a.getBoolean(R.styleable.CirclePageIndicator_snap, false);
        mDotInterval = a.getDimension(R.styleable.CirclePageIndicator_interval, defaultInterval);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float threeRadius = mRadius * 3 + mDotInterval;
