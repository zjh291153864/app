...
public class VideoPlayerActivity extends Activity implements UniversalVideoView.VideoViewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVideoUrl = getIntent().getStringExtra(ProjectDetailActivity.VIDEO_URL);
